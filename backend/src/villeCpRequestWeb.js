...
router.post("/villeCP", (req, res) => {
	...
	const security = md5("BDTEST13" + req.body.Pays + req.body.Ville + req.body.CP + req.body.NombreResultats + "PrivateK").toUpperCase();
	...
	const body = `<?xml version="1.0" encoding="utf-8"?>
		...
		<soap:Body>
			...
			<Ville>${req.body.Ville}</Ville>
			<CP>${req.body.CP}</CP>
			<NombreResultats>${req.body.NombreResultats}</NombreResultats>
